...
public class PayoutFacade {
    ...
    private final PayoutAddPayoutCandidateItemsUseCase payoutCandidateItemsUseCase;
    ...
    public void addPayoutCandidateItems(OrderDto order) {
        payoutCandidateItemsUseCase.addPayoutCandidateItems(order);
    }
    ...
    @Transactional
    public RsData<Integer> completePayoutMore(int limit) {
